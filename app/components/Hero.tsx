    ...
    return(
        <div className="pt-4 lg:pt-10">
            <div className="px-[20px] lg:px-[280px]">
                <h1 className="text-center text-[32px] leading-[40px] font-medium text-[#36485C] lg:text-[64px] lg:leading-[72px]">Start monitoring your website like a Pro</h1>
                ...
                <div className="flex w-full pt-8 justify-center gap-x-6">
                    <button className="bg-[#4328EB] w-1/2 py-4 px-8 text-white rounded-xl lg:w-fit">Try for free</button>
                    <button className="w-1/2 text-[#4328EB] flex items-center justify-center gap-x-2 lg:w-fit">View Pricing<span><Image src={Arrow} alt='arrow icon'/></span></button>
                </div>
            </div>
            ...
            <div className='relative flex h-full justify-center'>  {/* Another Section, gradients, trusted comapnies */}
                ...
                <div className='absolute bottom-5 flex flex-col w-full items-center'>
                    ...
                    <div className='flex w-full flex-col items-center lg:container lg:flex-row lg:justify-between lg:px-20 lg:mt-4'>
